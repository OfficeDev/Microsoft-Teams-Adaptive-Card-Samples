...
***For further design modifications** use the Microsoft Teams UI Kit in Figma to create, visualize, spec <a href="assets/expese-report-spec.png">(see current card spec)</a> , and verify the layouts before coding.<br />
